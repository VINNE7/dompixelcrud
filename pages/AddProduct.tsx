...
const AddProduct: NextPage = () => {
  ...
  <main className='flex  justify-center items-center  h-screen font-montserrat mx-auto'>
    <div className='flex flex-col gap-4 w-screen '>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-6 mx-auto '>
        ...
        <span className='flex flex-col gap-1'>
          <label htmlFor="price" className='text-sm font-bold'>Preço</label>
          <input 
            type="text" 
            placeholder='R$' 
            required
        ...
        <button type='submit' className='bg-black text-white mx-auto px-4 py-2'>Salvar</button>
      </form>
    </div>
  </main>
   )
